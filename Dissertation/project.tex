...
%% Change these:
\newcommand{\projecttitle}{Barter Near Me --\\ Why buy something to only use once?}
\newcommand{\projectauthor}{Nathan Garrihy \\[0.2cm] Cathal Donohoe}
\newcommand{\projectadvisor}{Dr Martin Kenirons}
...
\begin{document}
  \begin{titlepage}
    ...
    \begin{minipage}[t][3cm]{\textwidth}
      ...
      \textbf{\underline{\href{https://github.com/CathalDonohoe/FinalYearProject}{Link to GitHub Repository}}}
    \end{minipage}
