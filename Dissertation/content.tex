...
During the early stages of the project, we utilized an incremental and iterative approach to development. Since there was two of us working on the project, we found that this approach worked well because we were both operating on different schedules due to the personal reasons, so this development strategy allowed us to have more flexible schedules and relieved a lot of pressure, which was essential considering the pressure we were already under due to the COVID 19 pandemic.
