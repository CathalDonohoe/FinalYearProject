...
\includegraphics[scale = 0.8]{img/postman-JSON.PNG} \par
...
\includegraphics[scale=0.4]{img/teams.PNG}\par
...
In teams scheduled meetings \par
\includegraphics[scale=0.4]{img/TCalendar.PNG}\par
