              ...
              <div className="col-sm-4">
                <div className="panel panel-primary bg-transparent">
                  <a href="/availableItems" onClick={() => this.processChoice("Mens Clothing")}>
                    ...
                    <div className="panel-body"><img src={mensImg} className="img-responsive" alt="mens"/></div>
              ...
              <div className="col-sm-4">
                <div className="panel panel-primary bg-transparent">
                  <a href="/availableItems" onClick={() => this.processChoice("Womens Clothing")}>
                    <div className="panel-heading">Borrow Clothing</div>
                    <div className="panel-body"><img src={womensImg} className="img-responsive" alt="Womens" /></div>
              ...
              <div className="col-sm-4">
                <div className="panel panel-primary bg-transparent">
                  <a href="/availableItems" onClick={() => this.processChoice("Childrens Clothing")}>
                    <div className="panel-heading">Borrow Clothing</div>
                    <div className="panel-body"><img src={childsImg} className="img-responsive" alt="Childrens" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-danger bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Sports Balls")}>
                        ...
                        <div className="panel-body"><img src={ballImg} width="350px" height="150" className="img-responsive" alt="Sports" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-danger bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Sports Sticks/Bats/Clubs")}>
                        <div className="panel-heading">Borrow Sports Items</div>
                        <div className="panel-body"><img src={golfClubImg} width="350px" height="150" className="img-responsive" alt="Sticks/Bats/Clubs" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-danger bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Sports Misc")}>
                        <div className="panel-heading">Borrow Sports Items</div>
                        <div className="panel-body"><img src={otherEquipmentImg} width="350" height="150" className="img-responsive" alt="Sports Misc" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-success bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Electronic Devices")}>
                        ...
                        <div className="panel-body"><img src={electricDevices} width="350" height="150" className="img-responsive" alt="Devices" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-success bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Electronic Wires")}>
                        <div className="panel-heading">Borrow Electronics</div>
                        <div className="panel-body"><img src={electricCharger} width="350" height="150" className="img-responsive" alt="Wires" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-success bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Electronic Misc")}>
                        <div className="panel-heading">Borrow Electronics</div>
                        <div className="panel-body"><img width="350" height="150" src={electronicsImg} className="img-responsive" alt="Electronic Misc" /></div>
                      ...
                      <div className="col-sm-4">
                        <div className="panel panel-primary bg-transparent">
                          <a href="/availableItems" onClick={() => this.processChoice("Ladders")}>
                            ...
                            <div className="panel-body"><img width="350" height="150" src={ladderImg} className="img-responsive" alt="Ladders" /></div>
                      ...
                      <div className="col-sm-4">
                        <div className="panel panel-primary bg-transparent">
                          <a href="/availableItems" onClick={() => this.processChoice("Hand Tools")}>
                            <div className="panel-heading">Borrow Tools</div>
                            <div className="panel-body"><img width="350" height="150" src={handTools} className="img-responsive" alt="Hand Tools" /></div>
                      ...
                      <div className="col-sm-4">
                        <div className="panel panel-primary bg-transparent">
                          <a href="/availableItems" onClick={() => this.processChoice("Power Tools")}>
                            <div className="panel-heading">Borrow Tools</div>
                            <div className="panel-body"><img width="350" height="150" src={powerTools} className="img-responsive" alt="Power Tools" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-primary bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Gardening Tools")}>
                        <div className="panel-heading">Borrow Tools</div>
                        <div className="panel-body"><img width="350" height="150" src={gardeningTools} className="img-responsive" alt="Gardening" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-primary bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Painting Tools")}>
                        <div className="panel-heading">Borrow Tools</div>
                        <div className="panel-body"><img src={paintingTools} width="350px" height="150" className="img-responsive" alt="Painting" /></div>
                  ...
                  <div className="col-sm-4">
                    <div className="panel panel-primary bg-transparent">
                      <a href="/availableItems" onClick={() => this.processChoice("Fastener Tools")}>
                        <div className="panel-heading">Borrow Tools</div>
                        <div className="panel-body"><img src={fastenerTools} width="350px" height="150" className="img-responsive" alt="Fastener" /></div>
                    ...
                    <div className="row">
                      <div className="panel panel-danger bg-transparent">
                        <a href="/availableItems" onClick={() => this.processChoice("OtherItems")}>
                          ...
                          <div className="panel-body"><img src={otherItems} width="100%" className="img-responsive" alt="Other Items" /></div>
                        </a>
                      </div>
                    </div>
                  </div>
